...
>
> ⚠️ **2026-09-13 状态更新**：本文案中的「iOS 壳」（`mobile/ios/`，SwiftUI + WKWebView 复用前端）已退役——iOS 与 macOS 均改为 Swift 原生版（独立仓库 `qqplayer-swift`）。本文件保留为历史规划记录，当前形态见 README。
...
> ⚠️ 已退役（2026-09-13）：壳代码与前端壳桥接层已移除；以下定案内容保留为历史记录。
