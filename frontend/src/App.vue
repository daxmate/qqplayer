...
/* 控制区收起、仅剩歌词面板时：下方两角也恢复圆角（贴窗口底边），连播/跟唱通用 */
.main.continuous.no-controls:not(.has-music):not(.has-playlist) .lyric-panel,
.main.karaoke.no-controls:not(.has-music):not(.has-playlist) .karaoke-panel {
